...
public class ThirstLogic {
	...
	private static DamageSource damagerOverhydration = new DamageThirst();
	...
	public void onTick() {
		...
		//player.sendMessage(new TextComponentString(thirstLevel + " / " + thirstSaturation + " / " + thirstExhaustion));
