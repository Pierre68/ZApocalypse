...
public class PlayerContainer {
	...
	public static void addPlayer(EntityPlayer player) {
		...
		if (!ALL_PLAYERS.containsKey(player.getUniqueID().toString())) {
			ALL_PLAYERS.put(player.getUniqueID().toString(), container);
		}else{
			ALL_PLAYERS.remove(player.getUniqueID().toString());
			ALL_PLAYERS.put(player.getUniqueID().toString(), container);
		}
	}
	...
	public static PlayerContainer getPlayer(EntityPlayer player) {
		return ALL_PLAYERS.get(player.getUniqueID().toString());
	}
	...
	public static boolean containsPlayer(EntityPlayer player){
		return ALL_PLAYERS.containsKey(player);
	}
